...
@Component({
  selector: 'jhi-signature-process',
  templateUrl: './signature-process.component.html',
})
export class SignatureProcessComponent implements OnInit, OnDestroy {
  ...
  registerChangeInSignatureProcesses(): void {
    this.eventSubscriber = this.eventManager.subscribe('signatureProcessListModification', () => this.loadPage());
  }
