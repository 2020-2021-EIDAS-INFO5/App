...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.polytech.polysign.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.polytech.polysign.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.polytech.polysign.domain.User.class.getName());
