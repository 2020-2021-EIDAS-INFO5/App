...
import { AuthenticatedUserComponent } from 'app/entities/authenticated-user/authenticated-user.component';
...
describe('Component Tests', () => {
  describe('AuthenticatedUser Management Component', () => {
    let comp: AuthenticatedUserComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AuthenticatedUserComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new AuthenticatedUser(123)],
            headers,
          })
        )
      );
      ...
      expect(comp.authenticatedUsers && comp.authenticatedUsers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
