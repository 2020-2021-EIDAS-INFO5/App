...
describe('Service Tests', () => {
  describe('UserEntity Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(UserEntityService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new UserEntity(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a UserEntity', () => {
        ...
        service.create(new UserEntity()).subscribe(resp => (expectedResult = resp.body));
